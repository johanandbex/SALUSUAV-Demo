        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageChecked = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Uav = table.Column<Guid>(nullable: false),
                    ...
                    Flown = table.Column<bool>(nullable: false),
                    FlownDate = table.Column<DateTime>(nullable: true),
                    MaxRisk = table.Column<int>(nullable: false),
                    AvgRisk = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LatLonList = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataFeedTable = table.Column<string>(nullable: true),
                    DataFeedColumn = table.Column<string>(nullable: true),
                    DataFeedValue = table.Column<string>(nullable: true),
                    RiskValue = table.Column<double>(nullable: false),
                    RiskWeight = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxWindSpeed = table.Column<int>(nullable: false),
                    MaxAltitude = table.Column<int>(nullable: false),
                    BeyondSightEnabled = table.Column<bool>(nullable: false),
                    SafetyMechanism = table.Column<bool>(nullable: false),
                    UserId = table.Column<string>(nullable: true),
                    Weight = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UavData", x => x.Id);
                });
